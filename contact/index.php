   ...
   <body>
      ...
      <div class="ui large top fixed hidden menu">
         <div class="ui container">
            ...
            <a class="item active" href="/contact">Contact</a>
            ...
            <div class="sixteen wide column">
               ...
               <?php
                  ...
                  if(isset($_SESSION['admin'])){
                     echo "Congratulations! Now you can see the names!";
                     echo "<h1> Secure Info</h1><br>";

                     foreach (file("secureInfo.txt") as $line){
                        $arr = explode(' ',trim($line));
                        echo"<div class = \"ui violet header\">{$line}</div>";
                     }
                  }
                  else{
              ...
              <div><a class="ui fluid large violet submit button" href = "logout.php">LogOut</a></div>
			     </div>
               </div>
            </div>
         </div>
